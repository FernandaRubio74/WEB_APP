    ...
    return (
        <>
            ...
            <div className="max-w-5xl mx-auto mt-10 px-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
                ...
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 h-auto mb-4">
                    ...
                    <section className="bg-zinc-900 rounded-xl shadow-lg p-6 border border-zinc-800 flex flex-col h-auto">
